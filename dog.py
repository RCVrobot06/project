...
while True:
    ...
    # Difference of Gaussians (DoG) 방식으로 에지 감지
    blur1 = cv2.GaussianBlur(sharpened, (5, 5), 1.0)
    blur2 = cv2.GaussianBlur(sharpened, (5, 5), 2.0)
    dog_edges = cv2.absdiff(blur1, blur2)
